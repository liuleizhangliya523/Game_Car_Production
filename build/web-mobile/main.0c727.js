(function () {
    ...
    function onBridgeReady() {
        // console.log("main.0c727.js隐藏tool bar")
    ...
    function boot () {
        ...
        function setLoadingDisplay () {
            ...
            var splash = document.getElementById('number');
            var numberPercent = document.getElementById('numberPercent');

            cc.loader.onProgress = function (completedCount, totalCount, item) {
                var percent = 100 * completedCount / totalCount;
                if (splash) {
                    splash.style.height = percent.toFixed(2) + '%';
                    numberPercent.innerHTML = percent.toFixed(0) + '%';
                }
            };
        ...
        var bundledScript = settings.debug ? 'src/project.dev.js' : 'src/project.b5077.js';
        if (jsList) {
    ...
    if (false) {
        (function () {
            ...
            require('src/settings.a563c.js');
            require(window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.c4cb4.js');
    ...
    if (window.document) {
        ...
        cocos2d.async = true;
        cocos2d.src = window._CCSettings.debug ? 'cocos2d-js.js' : 'cocos2d-js-min.c4cb4.js';
